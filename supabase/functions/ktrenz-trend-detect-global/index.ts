...
- ONE ENTITY PER KEYWORD (CRITICAL): Each keyword must contain exactly ONE brand/product/entity. If an article mentions multiple items (e.g., "wearing Chanel shoes and a Prada jacket"), extract them as SEPARATE keywords: "Chanel two-tone shoes" and "Prada jacket" — NEVER combine them into one keyword like "Chanel shoes Prada jacket". Each keyword = one trackable commercial entity.
- Maximum 5 keywords
