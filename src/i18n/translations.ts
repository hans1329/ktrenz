...
const translations: Record<string, Record<Language, string>> = {
  ...
  "about.step5Desc": {
    en: "Earn K-Points by predicting trends, completing missions, and engaging with the platform. Your activity has real value.",
    ko: "트렌드 예측, 미션 완료, 플랫폼 활동으로 K-Points를 획득하세요. 팬 활동이 실질적 가치를 갖습니다.",
    ja: "トレンド予測、ミッション完了、プラットフォーム参加でK-Pointsを獲得。ファン活動に実際の価値を。",
    zh: "通过预测趋势、完成任务和参与平台活动赚取K-Points。您的活动具有真实价值。",
  },
  "about.step6Title": { en: "Redeem for Goods", ko: "굿즈 교환", ja: "グッズ交換", zh: "兑换商品" },
  "about.step6Desc": {
    en: "Use K-Points to purchase exclusive K-Pop merchandise, digital collectibles, and premium features.",
    ko: "K-Points로 독점 K-Pop 굿즈, 디지털 컬렉터블, 프리미엄 기능을 구매하세요.",
    ja: "K-Pointsで限定K-Popグッズ、デジタルコレクティブル、プレミアム機能を購入。",
  ...
  "about.section3Desc": {
    en: "Every prediction you make, every mission you complete, and every trend you track earns K-Points. Accumulate points and redeem them for exclusive merchandise, digital collectibles, premium access, and more — making your fan journey genuinely rewarding.",
    ko: "예측, 미션 완료, 트렌드 추적 활동마다 K-Points를 획득합니다. 포인트를 모아 독점 굿즈, 디지털 컬렉터블, 프리미엄 기능 등으로 교환하세요 — 팬 여정에 진정한 보상을 더합니다.",
    ja: "予測、ミッション完了、トレンド追跡のたびにK-Pointsを獲得。ポイントを貯めて限定グッズ、デジタルコレクティブル、プレミアム機能と交換しましょう。",
    zh: "每一次预测、完成的任务和追踪的趋势都能获得K-Points。累积积分可兑换独家商品、数字收藏品、高级权限等——让您的追星之旅真正有所回报。",
  },
