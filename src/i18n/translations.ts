...
const translations: Record<string, Record<Language, string>> = {
 ...
 "nav.battle": { en: "Battle", ko: "배틀", ja: "バトル", zh: "对战" },
  ...
  "about.diffRewardsDesc": {
    en: "K-Points aren't just vanity metrics — redeem them for merchandise, digital collectibles, and premium features in the KTrenZ ecosystem.",
    ko: "K-Points는 단순 지표가 아닙니다 — 굿즈, 디지털 컬렉터블, 프리미엄 기능으로 교환할 수 있습니다.",
    ja: "K-Pointsは単なる指標ではありません — グッズ、デジタルコレクティブル、プレミアム機能と交換可能です。",
