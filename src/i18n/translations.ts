...
const translations: Record<string, Record<Language, string>> = {
  ...
  "nav.artistView": { en: "Artists", ko: "아티스트", ja: "アーティスト", zh: "艺人" },
  ...
  "about.heroDesc": {
    en: "KTrenZ monitors keyword-level signals generated by K-Pop stars across news, social media, and streaming platforms — then scores, tracks, and grades each trend in real time so fans can predict what's next and earn rewards.",
    ko: "KTrenZ는 K-Pop 스타가 뉴스, 소셜 미디어, 스트리밍 플랫폼에서 만들어내는 키워드 신호를 모니터링한 뒤, 각 트렌드를 실시간으로 스코어링·추적·등급 평가하여 팬이 다음 트렌드를 예측하고 리워드를 받을 수 있게 합니다.",
    ja: "KTrenZはK-Popスターがニュース、SNS、ストリーミングで生み出すキーワードシグナルを監視し、各トレンドをリアルタイムでスコアリング・追跡・グレード評価。ファンが次を予測してリワードを獲得できます。",
    zh: "KTrenZ监测K-Pop明星在新闻、社交媒体和流媒体平台产生的关键词信号，然后对每个趋势进行实时评分、追踪和分级，让粉丝可以预测下一个热点并获得奖励。",
  },
  "about.cta": { en: "Explore Trends", ko: "트렌드 탐색", ja: "トレンドを探す", zh: "探索趋势" },
  "about.statKeywords": { en: "Keywords tracked daily", ko: "일일 키워드 추적", ja: "毎日追跡キーワード", zh: "每日追踪关键词" },
  "about.statTracking": { en: "Real-time monitoring", ko: "실시간 모니터링", ja: "リアルタイム監視", zh: "实时监控" },
  "about.statGrades": { en: "Trend grade levels", ko: "트렌드 등급 단계", ja: "トレンドグレード", zh: "趋势等级" },
  "about.statDataPoints": { en: "Data points per cycle", ko: "사이클당 데이터 포인트", ja: "サイクルごとのデータ", zh: "每周期数据点" },
  ...
  "t2.hero.spotifyBannerTitle": { en: "Predict trends & earn Spotify Premium free", ko: "트렌드를 예측하고 Spotify Premium 무료 이용권을 받으세요", ja: "トレンドを予測してSpotify Premium無料券をゲット", zh: "预测趋势赢取Spotify Premium免费券" },
