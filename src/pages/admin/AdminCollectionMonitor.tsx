...
const DATA_SOURCES = [
  ...
  },
  {
    ...
    description: '아티스트별 playcount, listeners 수집',
    usedIn: ['Music Score (18%)', 'Delta-over-Delta 성장 추적'],
    collectFrequency: '6h',
  },
  {
    id: 'deezer_music',
  ...
  },
  {
    ...
    apiProvider: 'Last.fm Geo API',
    description: '국가별 Top 1000 아티스트 매칭',
