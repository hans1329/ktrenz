...
function ArtistSection({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="max-w-lg mx-auto px-2 sm:px-0 mb-3">
        <button
          onClick={onPick}
          disabled={disabled}
          className={`w-full flex items-center justify-between px-4 py-4 rounded-full transition-all border shadow-sm ${
            isPicked ? "bg-primary/5 border-primary/30 shadow-primary/10" : "bg-card border-transparent hover:bg-muted/50"
          } ${disabled ? "opacity-60" : ""}`}
        >
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-16 pb-24 space-y-5">
        {/* Title + Flip Timer */}
        <div className="text-center space-y-4 pt-6 max-w-lg sm:max-w-4xl mx-auto px-4">
