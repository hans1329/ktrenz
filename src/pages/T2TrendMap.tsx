  ...
  return (
    <>
      ...
      >
        ...
        >
          {VIEW_ORDER.map((mode) => (
            <div key={mode} className={cn("h-full w-full flex-shrink-0 overflow-y-auto overscroll-contain pb-24 scrollbar-hide transition-all duration-300", headerCollapsed ? "pt-[6.5rem]" : "pt-[9rem]")}
              onScroll={(e) => {
