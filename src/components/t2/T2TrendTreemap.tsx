                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              idx === 0 ? "w-[320px] md:w-[360px]" : "w-[200px] md:w-[240px]",
                              isSelected
                          ...
                          >
                            ...
                            <div className={cn("relative w-full bg-muted/30 overflow-hidden min-h-0", idx === 0 ? "h-[360px]" : "flex-1 min-h-[160px] max-h-[220px]")}>
                              {bgImg ? (
