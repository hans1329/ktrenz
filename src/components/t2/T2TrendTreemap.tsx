                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1 px-1">
                              <svg viewBox="0 0 100 24" className="flex-1 h-[20px]" preserveAspectRatio="none">
                                <defs>
                              ...
                              <span className="text-[8px] text-muted-foreground/60 shrink-0">{formatAge(item.detectedAt)}</span>
                            </div>
