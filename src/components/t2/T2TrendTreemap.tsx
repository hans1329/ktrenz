                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              idx === 0 ? "w-[320px] md:w-[360px]" : "w-[300px] md:w-[320px]",
                              isSelected
                          ...
                          >
                            ...
                            <div className={cn("relative w-full bg-muted/30 overflow-hidden min-h-0", <div className={cn("relative w-full bg-muted/30 overflow-hidden min-h-0", idx === 0 ? "h-[360px]" : "h-[340px]")}>)}>
                              {bgImg ? (
