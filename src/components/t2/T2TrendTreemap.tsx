                      ...
                      {items.slice(0, 15).map((item, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={cn("relative w-full bg-muted/30 overflow-hidden flex-1 min-h-0", <div className={cn("relative w-full bg-muted/30 overflow-hidden flex-1 min-h-0", idx === 0 ? "aspect-[4/5]" : "aspect-square")}>)}>
                              {bgImg ? (
