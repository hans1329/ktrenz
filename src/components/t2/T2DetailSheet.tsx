...
const T2DetailSheet = ({ tile, rank, totalCount, onClose }: { tile: TrendTile | null; rank?: number; totalCount?: number; onClose: () => void }) => {
  ...
  return (
    <Sheet open={!!tile} onOpenChange={(open) => !open && onClose()}>
      <SheetContent side="bottom" className="rounded-t-2xl max-h-[85dvh] overflow-hidden border-border sm:max-w-lg sm:mx-auto flex flex-col">
                ...
                {([
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      betOutcome === key
                        ? "bg-teal-500/20 border-teal-400 ring-1 ring-teal-400/50 shadow-[0_0_8px_rgba(45,212,191,0.3)]"
                        : `bg-${color}-500/5 border-border/30 hover:border-teal-400/40`
                    )}
                  ...
                  <div className="flex flex-col items-center gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <Input
                        ...
                        className="w-36 sm:w-44 h-12 sm:h-14 text-center !text-2xl sm:!text-3xl font-black [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                      />
