...
import { TrendingUp, Clock, ExternalLink, ChevronRight, Share2, Rocket, Copy } from "lucide-react";
...
const T2_LABELS: Record<string, Record<string, string>> = {
  ...
  alreadyPredicted: { en: "Prediction submitted ✅", ko: "예측 완료 ✅", ja: "予測済み ✅", zh: "已预测 ✅" },
