  ...
  if (!user) {
    const banners = [
      ...
      <button
        ...
        className="w-full min-w-full shrink-0 rounded-2xl flex flex-col items-center justify-center text-center p-6"
        style={{ background: "linear-gradient(135deg, hsl(141 69% 38%), hsl(141 69% 30%))", minHeight: "220px" }}
      >
