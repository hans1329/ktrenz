...
const CATEGORY_META: Record<string, {label: string;icon: typeof Youtube;color: string;}> = {
  ...
  album: { label: "Sales", icon: Disc3, color: "text-amber-400" }
};
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl text-foreground leading-snug tracking-tight whitespace-pre-line lg:text-6xl font-bold">
              {t("hero.title")}
            </h1>
