          ...
          {rects.map((rect, rectIndex) => {
            ...
            return (
              <button key={rect.item.id} onClick={() => handleTileClick(rect.item)}
                ...
                {rect.item.isNew && (
                  <span className="absolute top-0 right-0 z-30 <span className="absolute top-0 right-0 z-30 bg-amber-400 text-black font-black rounded-bl-md flex items-center justify-center" flex items-center justify-center"
