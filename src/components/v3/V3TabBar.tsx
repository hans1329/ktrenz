            ...
            if (tab.isCenter) {
              ...
              return (
                <button key={tab.id} onClick={handleProfileClick} className="flex items-center justify-center -mt-3 relative">
                   <div className={cn("w-[72px] h-[72px] rounded-full transition-all duration-200 overflow-hidden grid place-items-center", profile?.avatar_url ? "bg-black" : "bg-secondary")}>
                    {profile?.avatar_url ? (
