        ...
        <div className="px-5 pb-6 space-y-5 overflow-y-auto">
          ...
          <div className="flex gap-2">
            ...
            <div className="basis-1/2 min-w-0 rounded-xl overflow-hidden text-left">
              {/* Top half */}
              <div className="relative px-3 py-1.5" style={{ background: 'linear-gradient(135deg, rgba(139,92,246,0.75), rgba(59,130,246,0.65), rgba(6,182,212,0.5))' }}>
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-primary-foreground font-semibold text-sm" style={{ color: '#ffffff' }}>
